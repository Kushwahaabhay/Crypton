    ...
    {#if !data.verified}
        <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-sm">
            <div class="relative border border-primary/20 bg-[#07070a] p-8 w-full max-w-sm shadow-2xl">
                ...
                <p class="font-mono text-primary text-[10px] tracking-[0.4em] uppercase mb-1">USE ONLY LOWERCASE</p>
                <h2 class="font-display text-2xl font-black text-white mb-1">Event Over (Password:- sachin)</h2>
                <p class="font-mono text-white/40 text-xs mb-6">If you stuck on verifying, pls refresh</p>
                <input
                    type="password"
